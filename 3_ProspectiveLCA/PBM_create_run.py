...
futura_loader_file = '{}/{}LCI/Ecoinvent_WFLDB_save.fl'.format(os.path.dirname(os.getcwd()), outputPath)
...
f.save('{}/{}/ProspectiveLCA/EcoWFLDB_{}_{}.fl'.format(os.path.dirname(os.getcwd()), outputPath,analysis_year, scen))
