...
## Saving the project's databases
#print('Save databases to a .fl file')
...
#f.database.extract_bw2_database(project_name, 'biosphere3')
#f.database.extract_bw2_database(project_name, 'ecoinvent3_5_cutoff')

#print(f.database.database_names)

#f.save(os.path.dirname(os.getcwd())+outputPath+'/Ecoinvent_WFLDB.fl')
